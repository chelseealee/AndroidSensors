...
public class SnareActivity extends Activity
{
    ...
    private AssetFileDescriptor _snare_1;
    private AssetFileDescriptor _snare_2;
    private AssetFileDescriptor _snare_3;
    private AssetFileDescriptor _snare_4;
    private AssetFileDescriptor _snare_5;
    private AssetFileDescriptor _snare_6;
...
//                                playAudio();
        ...
        _snare_1 = getApplicationContext().getResources().openRawResourceFd(R.raw.snare1);
        _snare_2 = getApplicationContext().getResources().openRawResourceFd(R.raw.snare2);
        _snare_3 = getApplicationContext().getResources().openRawResourceFd(R.raw.snare3);
        _snare_4 = getApplicationContext().getResources().openRawResourceFd(R.raw.snare4);
        _snare_5 = getApplicationContext().getResources().openRawResourceFd(R.raw.snare5);
        _snare_6 = getApplicationContext().getResources().openRawResourceFd(R.raw.snare6);
